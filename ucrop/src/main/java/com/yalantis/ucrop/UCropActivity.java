...
//            this.getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.theme_color_secondary));
            this.getWindow().setNavigationBarColor(ContextCompat.getColor(this, R.color.ucrop_color_theme));
        }
